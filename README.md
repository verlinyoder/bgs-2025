...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/bgs-2025)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/bgs-2025
```

A live public deployment of this template is available at [https://bgs-2025.templates.workers.dev](https://bgs-2025.templates.workers.dev)
